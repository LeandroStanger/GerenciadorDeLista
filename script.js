...
function atualizarLista() {
    ...
    registros.forEach((registro, index) => {
        ...
        detalhes.textContent = ` 🎂 ${registro.idade} anos | 👫 ${registro.genero}`;

        let detalhes2 = document.createElement('div');
        detalhes2.className = 'registro-detalhes';
        detalhes2.textContent = ` 👩‍❤️‍💋‍👨 ${registro.relacionamento}`;

        let detalhes3 = document.createElement('div');
        detalhes3.className = 'registro-detalhes';
        detalhes3.textContent = ` 📍 ${registro.estado} - ${registro.cidade}`;

        let detalhes4 = document.createElement('div');
        detalhes4.className = 'registro-detalhes';
        detalhes4.textContent = ` 📧 ${registro.email} | 📞 ${registro.telefone}`;


        divInfo.appendChild(nome);
        divInfo.appendChild(detalhes);
        divInfo.appendChild(detalhes2);
        divInfo.appendChild(detalhes3);
        divInfo.appendChild(detalhes4);
